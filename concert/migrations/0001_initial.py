# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-03-05 16:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'GigGoer'), (2, 'Venue')])),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='venue_images')),
                ('concerts', models.ManyToManyField(related_name='comments', to='concert.Concert')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
