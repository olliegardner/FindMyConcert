...
function bookmark(concertid, pretty) {
    ...
    var $button;
    if (pretty) {
        $button = '<button class="btn btn-outline-danger" onclick = "removebookmark(' +concertid+ ');hideparent(this, true);" >Remove Bookmark</button>';
    } else {
        $button = '<button class="btn btn-outline-danger" onclick = "removebookmark(' +concertid+ ');hideparent(this, false);" >Remove Bookmark</button>';
    }
